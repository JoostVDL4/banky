...
class BankyLeftSection {
    ...
    makeTransactionsFromData(accountToShow,data){
        ...
        for(let i = 0; i < data[accountToShow].length; i++){
            ...
            this.transactionLogo = document.createElement("i");
            this.transactionLogo.classList = "fa-solid fa-dollar-sign";
            this.transactionLogo.innerText = data[accountToShow][i]["logo"];
            ...
            this.transactionElement.appendChild(this.transactionLogo);
        }
